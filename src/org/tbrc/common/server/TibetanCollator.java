...
public class TibetanCollator extends RuleBasedCollator {
	...
	protected static final String dz_BTRules = "[normalization on] "
	 ...
	 protected static final com.ibm.icu.text.RuleBasedCollator dz_BTCollator = createCollator();

	 protected static final com.ibm.icu.text.RuleBasedCollator createCollator() {
		 try {
			 return new com.ibm.icu.text.RuleBasedCollator(dz_BTRules);
		 } catch (Exception ex) {
			 return null;
		 }
	 }
	 public TibetanCollator() throws ParseException {
		 super("=A");
	 }
	...
	public int compare(String x, String y ) {
		 try {
			 String xStrU = converter.toUnicode(x);
			 String yStrU = converter.toUnicode(y);
			 int cmp = dz_BTCollator.compare(xStrU, yStrU);
			 return cmp;
		 } catch (Exception ex) {
			 return 0;
		 }
